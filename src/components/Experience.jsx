...
const experiences = [
  ...
  { role: 'Personal Web & QA Projects', company: 'Independent', date: '2023 – Present', desc: 'Built and deployed personal projects using HTML, CSS, JavaScript, Angular and React with a focus on responsive design and clean UI. Maintained a QA portfolio on GitHub documenting test plans, bug reports, and automated Postman collections. Managed version control using Git and GitHub.' },
